...
function FacebookLogin(props) {
    var _a, _b;
    const { appId, language = 'en_US', scope = 'public_profile, email', fields = 'name,email,picture', onSuccess, onFail, onProfileSuccess, style, children = 'Login with Facebook', render, autoLoad = false, useRedirect = false, useCustomerChat = false, } = props;
    ...
    return (react_1.default.createElement(material_1.Button, { variant: "outlined", color: "primary", onClick: handleButtonClick, style: style },
